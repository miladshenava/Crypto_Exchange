...
import 'package:crypto_exchange_flutter/ui/ui_helper/ShimmerMartketWidget.dart';
...
import '../provider/marketViewProvider.dart';
              ...
              child: Consumer<MarketViewProvider>(
                  ...
                  builder: (context,MarketViewProvider,child){
                    switch(MarketViewProvider.state.status){
                      ...
                      default: return const ShimmerMarketWidget();
